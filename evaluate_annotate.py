...
if __name__ == "__main__":
    ...
    with tf.device("/%s" % FLAGS.gpu):
        ...
        with sess.as_default():
            test_name = './data/jdqa/seg3/%d.tfrecords'
            result_fname = './data/jdqa/seg3/result/%d.txt'
            for test_id in range(195):
                test_record_file = test_name%(test_id)
                result_file_name = result_fname%(test_id)
                ...
                def dev_step():
                    ...
                    print("ID: %d, MeanAcc: %.4f" %(test_id, MeanAcc))
